      ...
      <div class="grid">
        ...
        <div class="col-12 py-0 mt-2 flex justify-content-between w-full">
          <div class="grid w-full px-0">
            ...
            <div class="col-6 xl:col-2 lg:col-3 md:col-6 col-12 pr-0">
              <Calendar
                class="w-full p-inputtext-sm"
                :manualInput="true"
                v-model="date.datetime2"
                hourFormat="24"
                showTime
                dateFormat="dd/mm/yy"
                v-maska="'##/##/####'"
            ...
            <div
              class="col-6 xl:col-4 lg:col-5 md:col-6 col-12 pr-0 flex justify-content-between"
            >
              <Dropdown
                ...
                @change="search_turnicates()"
              />
              <Button
                @click="search_turnicates()"
                icon="pi pi-search"
                size="small"
                severity="primary"
              />
    ...
    <div class="col-12 py-0">
      ...
      >
        ...
        <Column style="min-width: 100px">
          <template #header>
            <div
              class="text-800 text-sm lg:text-base xl:text-sm uppercase font-medium"
            >
              F.I.SH
            </div>
          </template>
        ...
        <Column style="min-width: 110px; width: 100px">
          ...
          <template #body="slotProps">
            <div class="flex justify-content-center w-full">
              <Chip
                :label="slotProps.data.status == 'IN' ? 'KIRISH' : 'CHIQISH'"
                :class="
                  slotProps.data.status == 'IN'
...
export default {
  ...
  methods: {
    get_deadlines() {
      this.loader = true;
      this.params.datetime1 = this.date.datetime1
        ? this.formatter.outDateFormatter(this.date.datetime1)
        : null;
      this.params.datetime2 = this.date.datetime2
        ? this.formatter.outDateFormatter(this.date.datetime2)
        : null;
      let param = this.params;
      Turnicated.get_Turnicateds(param).then((res) => {
    ...
    dowlaod_data() {
      ...
      this.params.datetime2 = this.date.datetime2
        ...
        : null;
      let param = this.params;
      Turnicated.dowload_Turnicateds(param)
        .then((response) => {
